      ...
      <Navbar fluid inverse fixedTop>
        <Grid>
          ...
          <Navbar.Collapse>
            <Nav>
              <NavItem
                onSelect={() => this.onChangeFilter(constants.BIKES_AVAILABLE)}
              ...
              <NavItem
                onSelect={() => this.onChangeFilter(constants.PARKS_AVAILABLE)}
            ...
            <Nav pullRight>
              ...
              <NavItem
                eventKey={5}
                href="#"
                onSelect={() => this.onSearch(this.state.searchText)}
              >
              ...
              <NavDropdown
                ...
                title={
                  <span style={{ height: 20 + "px" }}>
                    <img className="flag" alt={flag.locale} src={flag.flag} />
                  </span>
                }
                eventKey={4}
              >
                <MenuItem
                  ...
                  eventKey={"en"}
                >
                  <img className="flag" src={British} alt="British Flag" />{" "}
                  English
                </MenuItem>
                <MenuItem
                  ...
                  eventKey={"se"}
                >
                  <img className="flag" src={Swedish} alt="Svenska Flagga" />
                  Svenska
                </MenuItem>
              </NavDropdown>
            </Nav>
